...
- [x] Replace the React entry point with a standalone `index.html` page.
- [x] Move the BMI form behavior, unit switching, validation, result calculation, and reset handling into browser JavaScript.
- [x] Preserve the Vital Measure visual system in standalone CSS.
